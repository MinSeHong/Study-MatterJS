...
import Matter, { Engine, Render, Bodies, World, Mouse, MouseConstraint, Runner} from 'matter-js'
import './App.css';
...
function App (props){
  ...
  useEffect(() => {
    ...
    World.add(engine.current.world, [
      ...
      Bodies.rectangle(cw / 2,250,cw/2,10,{isStatic:true, angle: Math.PI * 0.1}),
      Bodies.rectangle(cw / 2,500,cw/2+600,10,{isStatic:true, angle: Math.PI * (-0.1)})
    ])
